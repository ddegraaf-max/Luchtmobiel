...
- **LinkedIn en Facebook**: de dagelijkse assistent (zie hieronder) verzamelt ook openbare socialemedia-berichten van 11 Luchtmobiele Brigade, de Business Club, de Draagploeg Veteranen Luchtmobiele Brigade en de Facebook-pagina *11 Luchtmobiele Brigade, Veteranenzaken*; die verschijnen als nieuwsbericht met het label *LinkedIn*/*Facebook* en een knop naar het origineel. Uitzetten kan met `NIEUWS_IMPORT_LINKEDIN=0`; de bronnenlijst staat in [docs/sponsor-assistent.md](docs/sponsor-assistent.md).
...
5. **Kenmerk en agenda.** Elk verzoek krijgt automatisch een kenmerk (RED2026001, RED2026002, … — per jaar oplopend) dat op de site, in de controlewachtrij en in gedeelde links staat. Hoort een verzoek bij een evenement (sponsorloop, mars, benefiet), vul dan bij het verzoek de datum (en eventueel tijd, einddatum en locatie) in: zodra het geplaatst is, verschijnt het ook in de **agenda** (categorie *Sponsoractie*) met een knop naar het verzoek. Wijzig of verwijder je het verzoek, dan volgt het agenda-item; haal je het agenda-item weg, dan komt het niet terug tot je bij het verzoek *In de agenda tonen* weer aanvinkt.

**Links delen via WhatsApp, LinkedIn of e-mail:** elke pagina bevat deelgegevens (Open Graph), zodat een gedeelde link een kaartje toont met het clubembleem, de titel en een korte omschrijving — bij een sponsorverzoek de titel en samenvatting van dat verzoek, bij een evenement datum en locatie (met de afbeelding), bij een partner het logo. Stel hiervoor `APP_URL` in op het echte adres van de site; zonder die variabele wordt het adres uit het verzoek afgeleid. (WhatsApp onthoudt een voorvertoning een tijdje; een wijziging zie je dus niet altijd direct.)
