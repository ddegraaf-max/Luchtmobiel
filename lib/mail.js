...
function mailLayout(titel, inhoudHtml, opties = {}) {
  ...
  // Versie in het adres: anders blijft een oude, gecachete kopie (met oude headers) dagenlang hangen.
  const embleem = `${basis}/static/img/mail-embleem.png?v=${encodeURIComponent(require('../package.json').version)}`;
